...
public class SysDept extends BaseEntity {
    ...
    /** 部门名称 */
    private String            accurateDeptName;
    ...
    public String getAccurateDeptName() {
        return accurateDeptName;
    }

    public void setAccurateDeptName(String accurateDeptName) {
        this.accurateDeptName = accurateDeptName;
    }
