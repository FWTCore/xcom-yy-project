...
public class DataScopeAspect {
    ...
    protected void handleDataScope(final JoinPoint joinPoint, DataScope controllerDataScope) {
        ...
        if (StringUtils.isNotNull(loginUser)) {
            ...
            if (StringUtils.isNotNull(currentUser) && !currentUser.isAdmin()) {
                ...
                dataScopeFilter(joinPoint, controllerDataScope, permission);
            }
        }
    }
     ...
     */
    public static void dataScopeFilter(JoinPoint joinPoint, DataScope controllerDataScope, String permission) {
        String deptAlias = controllerDataScope.deptAlias();
        String userAlias = controllerDataScope.userAlias();
        String projectAlias = controllerDataScope.projectAlias();
        ...
        if (StringUtils.isNotBlank(sqlString.toString())) {
            ...
            if (StringUtils.isNotNull(params) && params instanceof BaseEntityDO) {
                BaseEntityDO baseEntity = (BaseEntityDO) params;
                baseEntity.getParams().put(DATA_SCOPE, " AND (" + sqlString.substring(4) + ")");
            }
        }
    }
