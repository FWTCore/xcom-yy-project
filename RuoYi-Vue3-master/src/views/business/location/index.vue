<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="地点编码" prop="locationCode">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['business:location:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="locationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="地点编码" align="center" prop="locationCode" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="locationRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="地点编码" prop="locationCode">
          <el-input v-model="form.locationCode" placeholder="请输入地点编码" />
        </el-form-item>
        <el-form-item label="是否删除" prop="deleteFlag">
